...
fm.register(13,fm.fpioa.I2S0_WS, force=True)    # 19 on Go Board and Bit(new version)
fm.register(14,fm.fpioa.I2S0_SCLK, force=True)  # 18 on Go Board and Bit(new version)
